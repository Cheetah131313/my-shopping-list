...
function ListDetails() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await axios.get('https://my-shopping-list-omti.onrender.com/users'); 
  ...
  useEffect(() => {
    const fetchShoppingList = async () => {
      try {
        const response = await axios.get(`https://my-shopping-list-omti.onrender.com/shopping-lists/${id}`);
  ...
  try {
    ...
    const response = await axios.patch(`https://my-shopping-list-omti.onrender.com/shopping-lists/${id}/items/${itemId}`, {
  ...
  const handleSaveNameChange = async () => {
    ...
    try {
      const response = await axios.put(`https://my-shopping-list-omti.onrender.com/shopping-lists/${id}`, {
        name: newListName
      });
  ...
  const handleAddItem = async () => {
    ...
    try {
      const response = await axios.post(`https://my-shopping-list-omti.onrender.com/shopping-lists/${id}/items`, {
        name: newItemName,
        checked: false
      });
  ...
  const handleRemoveItem = async (itemId) => {
    ...
    try {
      await axios.delete(`https://my-shopping-list-omti.onrender.com/shopping-lists/${id}/items/${itemId}`);
